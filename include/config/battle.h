...
#define B_TRAINER_EXP_MULTIPLIER    FALSE // In Gen7+, trainer battles no longer give a 1.5 multiplier to EXP gain.
...
// Damage settings
#define B_BURN_DAMAGE               FALSE // In Gen7+, burn damage is 1/16th of max HP instead of 1/8th.
