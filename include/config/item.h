...
#define I_HEALTH_RECOVERY               FALSE  // In Gen7+, certain healing items recover a different amount of HP than they used to.
...
#define I_GRISEOUS_ORB_FORM_CHANGE      FALSE  // In Gen9+, the Griseous Orb no longer changes Giratina's form when held.
#define I_GEM_BOOST_POWER               FALSE  // In Gen5+, the Gem boost power was reduced from 50% to 30%.
